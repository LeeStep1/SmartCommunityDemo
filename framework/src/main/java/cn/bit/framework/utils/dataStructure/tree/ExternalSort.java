...
/**
 * 基于<a href="http://lib.csdn.net/base/hadoop" class='replace_word' title="Hadoop知识库" target='_blank' style='color:#df3434; font-weight:bold;'>大数据</a>量的外排序算法，分为二路归并和多路归并
 *
 * @author java2king
 * @link http://blog.csdn<a href="http://lib.csdn.net/base/dotnet" class='replace_word' title=".NET知识库" target='_blank' style='color:#df3434; font-weight:bold;'>.NET</a>/Java2King
 */
public class ExternalSort {

    public static int ITEM_COUNT = 2000000000; //总数
