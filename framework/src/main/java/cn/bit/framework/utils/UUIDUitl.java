...
public class UUIDUitl {
    ...
    public static String toFixdLengthString(String num, int fixdlenth) {
        ...
        if (fixdlenth - strNum.length() >= 0) {
            ...
            throw new RuntimeException("将字符串" + num + "转化为长度为" + fixdlenth + "的字符串发生异常！");
        }
        return sb.toString();
    }
    ...
    public static String generateGuid() {
        ...
        String mac = null;
        try {
            mac = CommonUtils.getMACAddress();
        } catch (Exception e) {
            e.printStackTrace();
        }
        String s = DigestUtils.md5Hex((mac == null ? System.currentTimeMillis() : mac) + StrUtil.get32UUID());
        return s;
    }

    public static void main(String[] args) {
        /*for (int i = 0; i < 10; i++) {
            System.err.println(generateGuid());
        }*/
        System.err.println(generateInteger(3));
    }
