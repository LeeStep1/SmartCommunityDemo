 ...
 */
public class AntPatternMatcher implements PatternMatcher {
    ...
    public static void main(String[] args) throws InterruptedException {
        /*PatternMatcher matcher = new AntPatternMatcher();
        System.err.println(" >>> " + matcher.matches("/auth/user/add*//*","/auth/user/add/k"));*/
        //System.err.println("166746326727@1".matches("^([0-9]+)@([0-1])$"));
